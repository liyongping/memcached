...
typedef struct {
    ...
    struct thread_stats stats;  /* Stats generated by this thread，线程统计信息 */
    struct conn_queue *new_conn_queue; /* queue of new connections to handle,需要处理的连接队列 */
